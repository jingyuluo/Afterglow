...
def MakeJob(outputdir,jobid, pathname):
    ...
    makeDataCMD="python DeriveHFETCorrections_corr_LB.py -f "+args.path+"/"+pathname
    ...
    cndlines.append("transfer_input_files    = DeriveHFETCorrections_corr_LB.py")
...
copyfile("DeriveHFETCorrections_corr_LB.py", args.jobdir+"/DeriveHFETCorrections_corr_LB.py")
